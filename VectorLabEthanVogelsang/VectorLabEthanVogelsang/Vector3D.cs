 ...
 * and convert that into the cartesiancomponents of a vector.
...
public class Vector3D
{
    ...
    {
        return String.Format("Vector: <{0:F2}, {1:F2}, {2:F2}>", GetX(), GetY(), GetZ());
    }
    ...
    {
        return String.Format("Magnitude {0:F2} Heading: {1:F2}° Pitch: {2:F2}°", 
    ...
    /// <param name="u"></param>
    /// <returns></returns>
    public static Vector3D operator&(double scalar, Vector3D u) =>
        new Vector3D(u.GetX() * scalar, u.GetY() * scalar, u.GetZ() * scalar);
    public static Vector3D operator &(Vector3D u, double scalar) =>
        new Vector3D(u.GetX() * scalar, u.GetY() * scalar, u.GetZ() * scalar);
    ...
    public static Vector3D CrossProduct(Vector3D v1, Vector3D v2) =>
        new Vector3D(v1.GetY() * v2.GetZ() - v2.GetY() * v1.GetZ(),   //X
